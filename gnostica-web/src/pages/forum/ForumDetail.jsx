                  ...
                  <div className="mt-5 pt-5 border-t border-border">
                    {post.status === 3 ? (
                      <div className="flex items-center gap-2 p-3 rounded-lg bg-rose-50 border border-rose-200">
                        <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 text-rose-500 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" /></svg>
                        <p className="text-sm text-rose-700 font-medium">
                          Bài viết này đã bị từ chối kiểm duyệt lúc {new Date(post.updatedAt).toLocaleString('vi-VN', {
                            day: '2-digit',
                            month: '2-digit',
                            year: 'numeric',
                            hour: '2-digit',
                            minute: '2-digit'
                          })} và sẽ bị xóa khỏi hệ thống sau 24h.
                        </p>
                      </div>
                    ) : (
