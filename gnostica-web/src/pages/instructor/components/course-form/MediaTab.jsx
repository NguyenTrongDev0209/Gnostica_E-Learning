...
export function MediaTab({ uploadVideoToBunny, setActiveUploads }) {
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div className="space-y-3">
          ...
          <div
            ...
            className={`aspect-video rounded-lg bg-muted border-2 border-dashed flex flex-col items-center justify-center p-4 transition-all cursor-pointer group ${thumbnail ? "border-success/20 bg-success/10" : "border-border hover:bg-secondary hover:border-success/20"}`}
          >
