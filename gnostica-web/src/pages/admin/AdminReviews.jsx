...
export default function AdminReviews() {
  return (
    <div className="space-y-6 animate-in fade-in duration-500">
      <div>
        <h1 className="text-2xl font-bold text-foreground tracking-tight">Đánh Giá &amp; Bình Luận</h1>
        <p className="text-sm text-muted-foreground mt-1">Kiểm duyệt đánh giá và bình luận từ học viên.</p>
      </div>
