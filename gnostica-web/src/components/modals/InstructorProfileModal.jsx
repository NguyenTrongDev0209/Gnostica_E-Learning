...
export default function InstructorProfileModal({ isOpen, onClose, instructor }) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:!max-w-[650px] w-full p-0 overflow-hidden border-none shadow-2xl bg-slate-50 animate-in zoom-in-95 duration-200">
        {/* Premium Banner Top */}
        ...
        <div className="px-6 -mt-14 relative z-10">
          ...
          <div className="flex flex-col sm:flex-row items-center sm:items-end justify-between gap-4 mb-6 text-center sm:text-left">
            <div className="relative">
              <div className="w-28 h-28 rounded-full p-1.5 bg-white shadow-lg overflow-hidden group">
                <img
                  ...
                  alt="Avt"
                  className="w-full h-full rounded-full object-cover bg-slate-100 transition-transform group-hover:scale-110 duration-500"
                />
              </div>
            </div>
            <div className="flex-1 pt-4 sm:pt-16">
              <h2 className="text-2xl font-black text-slate-900 tracking-tight leading-tight flex items-center gap-2 justify-center sm:justify-start">
                {instructor.name}
            ...
            <div className="flex items-center gap-2 pt-0 sm:pt-16">
              <div className="text-center bg-white px-3 py-2 rounded-xl border border-slate-200/60 shadow-sm">
          ...
          <div className="space-y-4 max-h-[55vh] overflow-y-auto pr-1 custom-scrollbar pb-6">
            ...
            <div className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
              <div className="p-3 px-4 bg-slate-50 border-b border-slate-100 flex items-center gap-2">
                <User className="w-4 h-4 text-indigo-500" />
                <h3 className="font-extrabold text-slate-800 text-[13px] uppercase tracking-wide">
            ...
            <div className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
              ...
              <div className="p-4 space-y-4 text-sm">
                <div>
                  ...
                  <p className="font-medium text-slate-600 mt-1 leading-relaxed italic border-l-2 border-slate-200 pl-3">
                    "{instructor.bio}"
                  </p>
                </div>
                ...
                <Button
                  variant="outline"
                  size="sm"
                  className="w-full font-bold border-slate-200 text-indigo-600 gap-2 hover:bg-indigo-50"
                >
            ...
            <div className="bg-gradient-to-br from-white to-slate-50 rounded-xl border border-slate-200 shadow-sm overflow-hidden">
              <div className="p-3 px-4 bg-slate-800 border-b border-slate-900 flex items-center gap-2 text-white">
              ...
              <div className="p-4 grid grid-cols-2 gap-4 text-sm">
                ...
                <div className="col-span-2 bg-slate-100/50 rounded p-2 border border-slate-200/50">
        ...
        <div className="p-4 bg-white border-t border-slate-200 flex items-center justify-between">
          ...
          <Button
            ...
            className="font-bold bg-slate-900 hover:bg-slate-800 text-white px-6"
          >
            Đóng
          </Button>
        </div>
