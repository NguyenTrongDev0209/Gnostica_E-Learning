...
const AppSearchInput = ({ className = "" }) => {
  ...
  return (
    <div className={`flex flex-col relative ${className}`}>
      ...
      <div className="flex items-center rounded-lg bg-white border border-slate-200 overflow-hidden shadow-sm h-10 focus-within:ring-2 focus-within:ring-primary/20 transition-all z-10">
        ...
        <div className="flex-1 flex items-center min-w-0 h-full">
          ...
          <Input
            ...
            className="border-none focus-visible:ring-0 shadow-none h-full text-base text-black placeholder:text-slate-400 pl-3 bg-transparent md:text-base"
        ...
        <button
          ...
          className="h-full px-5 flex items-center gap-2 bg-button-gradient text-white hover:opacity-90 transition-opacity whitespace-nowrap font-medium cursor-pointer"
        >
