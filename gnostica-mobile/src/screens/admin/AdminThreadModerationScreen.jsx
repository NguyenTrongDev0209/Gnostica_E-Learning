    ...
    return (
        <View className="flex-1 bg-slate-50">
            <View className="pt-[52px] pb-4 px-5 bg-white flex-row items-center border-b border-slate-100">
                ...
                <Text className="text-[18px] font-extrabold text-slate-800">Kiểm duyệt bài viết</Text>
            </View>
                ...
                {[1, 2].map((item) => (
                    <View key={item} className="bg-white p-4 rounded-2xl mb-4 border border-amber-200 shadow-sm">
                        <View className="flex-row items-center justify-between mb-2">
                            <Text className="text-xs font-bold text-amber-600">Chờ duyệt</Text>
                            <Text className="text-[10px] text-slate-400">Tác giả: Nam Nguyễn</Text>
                        </View>
                        
                        <Text className="text-base font-bold text-slate-800 mb-1">Cách tối ưu render trong React Native?</Text>
                        ...
                        <View className="flex-row gap-3">
                            <TouchableOpacity className="flex-1 bg-red-50 py-2.5 rounded-xl flex-row items-center justify-center">
                                ...
                                <Text className="text-red-500 font-bold text-xs ml-1.5">Từ chối</Text>
                            </TouchableOpacity>
                            <TouchableOpacity className="flex-1 bg-emerald-500 py-2.5 rounded-xl flex-row items-center justify-center">
                                <CheckCircle2 size={16} color="#fff" />
                                <Text className="text-white font-bold text-xs ml-1.5">Phê duyệt</Text>
                            </TouchableOpacity>
                        </View>
                    </View>
                ))}
